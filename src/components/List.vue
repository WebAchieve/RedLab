  ...
  <div class="list">
    <ul class="list-wrap">
      <li
        ...
        :key="list.id"
      >
        <span class="list-item__id">#{{ list.id+1 }}</span>
        <div class="list-item__wrap">
          <img
            class="list-item__img"
            :src="getImgUrl(list.image)"
            :alt="list.name.ru"
          />
          <div class="list-item__name">{{ list.name[lang] }}</div>
        </div>
        <div class="list-item__wrap">
          <div class="ist-item__age">
            {{ list.age }}{{ lang == "ru" ? " лет" : " years old" }}
          </div>
          <div class="ist-item_phone">{{ list.phone }}</div>
        </div>
